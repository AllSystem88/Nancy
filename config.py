...
# API URL - here
API_URL = getenv("API_URL", "https://onegrab.zeabur.app")

# API KEY - here
API_KEY = getenv("API_KEY", None) #for api contact @its_deep_ydv
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AllSystem88/Nancy",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/exampurss_official")
...
TG_VIDEO_FILESIZE_LIMIT = int(getenv("TG_VIDEO_FILESIZE_LIMIT", 1000000000))
